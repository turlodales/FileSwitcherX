...
APPLICATION_NAME=FileSwitcherX
rm -rf build
mkdir build
...
mkdir Payload
cp -r FileSwitcherX.app Payload/FileSwitcherX.app
zip -vr FileSwitcherX.ipa Payload
rm -rf FileSwitcherX.app
rm -rf DerivedDataApp
rm -rf Payload
zip -vr share.zip FileSwitcherX.ipa
